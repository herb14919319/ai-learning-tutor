...
Schema v2 applies to Tutor traffic entering through LINE, Messenger, and Web Chat requests that share the model-call boundary.
...
| `entrypoint` | string | `line`, `messenger`, or `web_chat` |
